...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// button4
			// 
			this->button4->Location = System::Drawing::Point(407, 580);
			...
			// button3
			// 
			this->button3->Location = System::Drawing::Point(326, 580);
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(243, 580);
			...
			this->groupBox2->Location = System::Drawing::Point(59, 326);
			...
			this->groupBox1->Location = System::Drawing::Point(59, 49);
			...
			// Column3
			// 
			this->Column3->HeaderText = L"Codigo Ub:";
			...
			this->ClientSize = System::Drawing::Size(774, 649);
			...
			this->Text = L"frmMantenimientoDepartamento";
