...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// button4
			// 
			this->button4->Location = System::Drawing::Point(469, 486);
			...
			// button3
			// 
			this->button3->Location = System::Drawing::Point(361, 486);
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(252, 486);
			...
			this->groupBox2->Size = System::Drawing::Size(807, 299);
			...
			this->dataGridView1->Size = System::Drawing::Size(676, 219);
			...
			this->groupBox1->Size = System::Drawing::Size(807, 148);
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(652, 58);
			...
			// textBox2
			// 
			this->textBox2->Location = System::Drawing::Point(429, 59);
			...
			this->label3->Location = System::Drawing::Point(345, 63);
			...
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(107, 59);
			...
			this->ClientSize = System::Drawing::Size(888, 546);
...
#pragma endregion
	...
	private: System::Void button3_Click(System::Object^ sender, System::EventArgs^ e) {
		if (this->dataGridView1->SelectedRows->Count > 0)
		{
			...
			List<Usuario^>^ listaUsuarios = usuarioController->buscarTodos();
			mostrarGrilla(listaUsuarios);
		}
		else
		{
