...
namespace InvernaderoView {
	...
	public:
		...
		frmEditarEmpresa(Empresa^ empresa)
		{
			InitializeComponent();
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(284, 439);
			...
			this->button2->Click += gcnew System::EventHandler(this, &frmEditarEmpresa::button2_Click);
			// 
			// button1
			// 
			...
			this->button1->Click += gcnew System::EventHandler(this, &frmEditarEmpresa::button1_Click);
			// 
			// groupBox1
			// 
			...
			this->groupBox1->Location = System::Drawing::Point(33, 32);
			this->groupBox1->Margin = System::Windows::Forms::Padding(3, 2, 3, 2);
			this->groupBox1->Name = L"groupBox1";
			this->groupBox1->Padding = System::Windows::Forms::Padding(3, 2, 3, 2);
			this->groupBox1->Size = System::Drawing::Size(447, 366);
			this->groupBox1->TabIndex = 15;
			this->groupBox1->TabStop = false;
			this->groupBox1->Text = L"Datos del Empresa";
			// 
			// textBox6
			// 
			this->textBox6->Location = System::Drawing::Point(189, 317);
			...
			this->label6->Location = System::Drawing::Point(53, 317);
			...
			// textBox5
			// 
			this->textBox5->Location = System::Drawing::Point(189, 260);
			...
			this->label4->Text = L"DireccionFiscal:";
			// 
			// label3
			// 
			...
			this->ClientSize = System::Drawing::Size(513, 495);
			this->Controls->Add(this->button2);
			this->Controls->Add(this->button1);
			this->Controls->Add(this->groupBox1);
			this->Name = L"frmEditarEmpresa";
			this->Text = L"frmEditarEmpresa";
...
#pragma endregion
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		String^ direccionFiscal = this->textBox4->Text;
		...
		empresaController->actualizarEmpresa(codigo, nombre, ruc, direccionFiscal, telefono, email);
		MessageBox::Show("El empresa ha sido actualizado exitosamente");
		this->Close();
	}
	...
	private: System::Void frmEditarEmpresa_Load(System::Object^ sender, System::EventArgs^ e) {
		this->textBox1->Text = Convert::ToString(this->empresa->getCodigo());
		this->textBox2->Text = this->empresa->getNombre();
		this->textBox3->Text = this->empresa->getRuc();
		this->textBox4->Text = this->empresa->getDireccionFiscal();
		this->textBox5->Text = this->empresa->getTelefono();
		this->textBox6->Text = this->empresa->getEmail();
	}
};
}
