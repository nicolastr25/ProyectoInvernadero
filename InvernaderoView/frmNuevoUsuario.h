...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->ClientSize = System::Drawing::Size(515, 374);
...
#pragma endregion
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		usuarioController->agregarUsuario(codigo, nombre, user, clave);
		MessageBox::Show("El usuario se ha registrado exitosamente"); //Muestra una caja de texto con el mensaje
		this->Close();
	}
