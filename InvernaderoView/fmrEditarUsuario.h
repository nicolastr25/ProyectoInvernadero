...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(268, 319);
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(137, 319);
			...
			this->groupBox1->Size = System::Drawing::Size(447, 267);
			...
			this->ClientSize = System::Drawing::Size(508, 369);
			...
			this->Load += gcnew System::EventHandler(this, &fmrEditarUsuario::fmrEditarUsuario_Load);
