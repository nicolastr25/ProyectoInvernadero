...
namespace InvernaderoView {
	...
	/// Resumen de Cultivo
	/// </summary>
	public ref class Cultivo : public System::Windows::Forms::Form
	{
	public:
		Cultivo(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->groupBox1->Location = System::Drawing::Point(47, 11);
			...
			this->groupBox2->Location = System::Drawing::Point(47, 288);
			...
			this->button1->Click += gcnew System::EventHandler(this, &Cultivo::button1_Click);
			// 
			// textBox2
			// 
			...
			this->label3->Click += gcnew System::EventHandler(this, &Cultivo::label3_Click);
			// 
			// textBox4
			// 
			...
			// button4
			// 
			this->button4->Location = System::Drawing::Point(395, 542);
			...
			// button3
			// 
			this->button3->Location = System::Drawing::Point(314, 542);
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(231, 542);
			...
			this->ClientSize = System::Drawing::Size(762, 586);
