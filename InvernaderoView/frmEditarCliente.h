...
namespace InvernaderoView {
	...
	public:
		...
		frmEditarCliente(Cliente^ cliente)
		{
			InitializeComponent();
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(294, 465);
			...
			this->groupBox1->Location = System::Drawing::Point(37, 39);
			...
			this->ClientSize = System::Drawing::Size(527, 510);
...
#pragma endregion
	private: System::Void frmEditarCliente_Load(System::Object^ sender, System::EventArgs^ e) {
		this->textBox1->Text = Convert::ToString(this->cliente->getCodigo());
		this->textBox2->Text = this->cliente->getNombre();
		this->textBox3->Text = this->cliente->getDni();
		this->textBox4->Text = this->cliente->getTelefono();
		this->textBox5->Text = this->cliente->getEmail();
		this->textBox6->Text = this->cliente->getDireccion();
	}
	...
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		clienteController->actualizarCliente(codigo, nombre, dni, telefono, email, direccion, distrito);
